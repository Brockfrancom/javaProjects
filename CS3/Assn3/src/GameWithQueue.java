 ...
 * Game with queue this is used in SliderGame.
...
public class GameWithQueue {
    ...
    public String playGiven(String label, Board b){
        ...
        for (int i = 0; i<10000000; i++) { // makes all possible moves and append legal boards to the queue
            ...
            for (char m:moveList) {
                ...
                var move = copy.makeMove(m, current.lastMove);
                if (move != ' ') {
                    copy.lastMove = move;
    ...
    public static void gameWithQueue(String[] args) {
