 ...
 * Board class for the slider puzzle
...
public class Board {
    ...
    public int[][] board;  // Values of board
    private int blankRow;   // Row location of blank
    private int blankCol;   // Column location of blank
    public char lastMove = 'P'; // keeps track of the last move
    public String moves = ""; // keeps a list of moves since the first board
    ...
    public static void board(String[] args) {
        Board b = new Board();
    ...
    public void showMe(String moves) {
        var moveList = moves.toCharArray();
        //System.out.println(toString());
        for (char letter:moveList) {
            makeMove(letter, ' ');
            System.out.println(toString());
        }
    }
